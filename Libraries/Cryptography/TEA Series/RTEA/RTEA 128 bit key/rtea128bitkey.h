...
// ===============================================================================
//
// Ёта библиотека, реализует криптографический алгоритм RTEA
// с размером ключа 128 бит. ‘ункции библиотеки позвол€ют использовать
// различные режимы шифровани€ данных: ECB, CBC, PCBC, CFB и OFB
//
// -------------------------------------------------------------------------------
//
