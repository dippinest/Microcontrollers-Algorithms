...
// случайных чисел для функции STRINGX_Generate_Random_Strings
// 
// -------------------------------------------------------------------------------
// callback function of
// the random number generator for the STRINGX_Generate_Random_Strings function
//
...
int main(void)
{
	...
	for (uint16_t i = 0; i < NUM_OF_STRINGS; ++i)
	{
		...
		STRINGX_Generate_Random_Strings(strings[i], string_random_size, 'A', 'Z', random_generator);
	...
	//
	STRINGX_Strings_Lexicographic_Bubble_Sort(strings_pointers, NUM_OF_STRINGS, STRINGX_BuildIn_Custom_STRCMP);
