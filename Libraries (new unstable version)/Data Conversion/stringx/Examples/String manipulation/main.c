...
int main()
{
	...
	//
	STRINGX_Trim_All_Extra_Symbols(str, ' ');
	...
	//
	STRINGX_Replace_Substring(str, str_buffer, "Hello", "Hi");
	...
	//
	STRINGX_Delete_All_Substrings(str_buffer, "world");
	...
	//
	STRINGX_Insert_Substring_By_Pos(str_buffer, "all world", 4);
