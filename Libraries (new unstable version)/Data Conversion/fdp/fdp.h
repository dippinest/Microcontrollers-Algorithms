...
//
// Внимание! При работе с FDP важно помнить о возможностях переполнения!
...
//
// Attention! When working with FDP, it is important to remember
...
char *FDP_Int16Base_Convert_Number_To_String
(
	char *string_buffer,
...
int16_t FDP_Int16Base_Convert_String_To_Number
(
	const char *string,
...
char *FDP_Int32Base_Convert_Number_To_String
(
	char *string_buffer,
...
int32_t FDP_Int32Base_Convert_String_To_Number
(
	const char *string,
...
char *FDP_Int64Base_Convert_Number_To_String
(
	char *string_buffer,
...
int64_t FDP_Int64Base_Convert_String_To_Number
(
	const char *string,
