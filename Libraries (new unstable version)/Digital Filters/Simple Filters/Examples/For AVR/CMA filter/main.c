...
int main(void)
{
	...
	while (1)
	{
		...
		float adc_val = ADC_Get_Voltage_Value(MAX_REF_VOLTAGE) + Filters_Get_Gaussian_Noise(NOISE_AMPLITUDE) + Filters_Get_Splash_Float(SPLASH_AMPLITUDE, 1000);
