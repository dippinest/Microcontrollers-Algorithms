...
- Алгоритмы генераторов псевдослучайных чисел (ГПСЧ)
   ...
   - [Библиотека ГПСЧ из класса LFSR генераторов с длиной регистра 128 бит](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/PRNG%20Algorithms/XOR128LFSR)
...
- Algorithms of pseudorandom number generators (RNG)
   ...
   - [A library of RNGs from the LFSR class of generators with a register length of 128 bits](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/PRNG%20Algorithms/XOR128LFSR)
