...
- Алгоритмы генераторов псевдослучайных чисел (ГПСЧ)
   ...
   - [Библиотека ГПСЧ из класса Xorshift генераторов с длиной регистра  16 бит](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/PRNG%20Algorithms/XORShift16)

   - [Библиотека ГПСЧ из класса Xorshift генераторов с длиной регистра  32 бит](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/PRNG%20Algorithms/XORShift32)

   - [Библиотека ГПСЧ из класса Xorshift генераторов с длиной регистра 128 бит](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/PRNG%20Algorithms/XORShift128)
...
- Алгоритмы управления с обратной связью (ТАУ):

   - [Программная реализация компаратора с верхним и нижним гистерезисом](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/Feedback%20control/Comparator)


- Прочие алгоритмы:

   - [Алгоритм расчета температуры с помощью NTC терморезистора](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/Other%20solutions%20and%20code%20examples/NTC%20Thermometer)

   - [Алгоритмы работы со статическими массивами](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/Other%20solutions%20and%20code%20examples/Array%20Data%20Functions)
...
- Algorithms of pseudorandom number generators (RNG)
   ...
   - [A library of RNGs from the Xorshift class of generators with a register size of  16 bits](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/PRNG%20Algorithms/XORShift16)

   - [A library of RNGs from the Xorshift class of generators with a register size of  32 bits](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/PRNG%20Algorithms/XORShift32)

   - [A library of RNGs from the Xorshift class of generators with a register size of 128 bits](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/PRNG%20Algorithms/XORShift128)
...
- Feedback Control Algorithms (Control engineering):

   - [Software implementation of a comparator with upper and lower hysteresis](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/Feedback%20control/Comparator)


- Other algorithms:

   - [Algorithm for calculating temperature using an NTC thermistor](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/Other%20solutions%20and%20code%20examples/NTC%20Thermometer)

   - [Algorithms for working with static arrays](https://github.com/dippinest/Microcontrollers-Algorithms/tree/main/Libraries/Other%20solutions%20and%20code%20examples/Array%20Data%20Functions)
